...
import type { PurchaseReturn } from "@/features/purchase-returns/types/purchase-return";
      ...
      <section className="rounded-2xl border bg-card shadow-sm">
        <div className="flex min-h-72 flex-col items-center justify-center px-6 text-center">
          ...
          <p className="mt-1 max-w-sm text-sm text-muted-foreground">
            Try changing your filters or create a new purchase return.
          </p>
        </div>
      </section>
    );
                  ...
                  <td className="px-5 py-4">
                    <div className="flex justify-end">
                      <Button
                        ...
                        aria-label={`View purchase return from ${purchaseReturn.purchase.supplier.name}`}
                        onClick={() =>
                          onView(
                            purchaseReturn,
                          )
